...
import com.tyron.nanoj.core.indexing.iterators.SourceRootsIndexingIteratorsProvider;
...
public final class EditorCore {
    ...
    public static void register(Project project) {
        ...
        // Indexing iterators provider (IntelliJ-like: iterators provide roots; indexing runner consumes them).
        ProjectServiceManager.registerBindingIfAbsent(project, IndexingIteratorsProvider.class, SourceRootsIndexingIteratorsProvider.class);
